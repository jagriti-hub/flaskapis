...
def main():
  ...
  status,statusmessage,response=s3files.write_output_file(table_outputfile, table_output)
  if status == "error":
  ...
  if table_status == "success":
    ...
    print("table_output_status: ", table_output_status)
  ...
  if "secondary" not in tableconfig["indexes"]:
    tableconfig["indexes"]["secondary"]=[]
  print("secondary_key_output: ",secondary_key_output)
